 ...
 */
public class MaronaOutline extends Shape2d implements javax.swing.Icon {
    ...
    public MaronaOutline() {
        ...
        root = new TreeNode("MARONA OUTLINE", null, 0);
        ...
        ((GeneralPath) shape).moveTo(18.855, 120.734);
        ((GeneralPath) shape).curveTo(18.855, 120.734, 19.875, 130.0, 22.75, 131.375);
        ...
        ((GeneralPath) shape).curveTo(35.729, 138.37099, 41.105, 136.886, 41.105, 136.886);
        ((GeneralPath) shape).curveTo(41.105, 136.886, 44.746, 144.123, 48.934998, 143.748);
        ((GeneralPath) shape).curveTo(53.123997, 143.373, 55.248997, 140.91501, 55.248997, 140.91501);
        ((GeneralPath) shape).curveTo(55.248997, 140.91501, 59.364, 147.11601, 63.873997, 146.99802);
        ((GeneralPath) shape).curveTo(68.383995, 146.88002, 71.598, 142.91602, 71.598, 142.91602);
        ((GeneralPath) shape).lineTo(49.624, 110.432014);
        ...
        ((GeneralPath) shape).curveTo(47.133, 195.003, 39.833, 194.934, 37.166, 194.925);
        ((GeneralPath) shape).curveTo(34.499, 194.917, 24.25, 198.917, 24.25, 198.917);
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xFDAB83), new Color(0xC15930), shape);
        ...
        ((GeneralPath) shape).lineTo(87.516, 213.58899);
        ((GeneralPath) shape).curveTo(87.516, 213.58899, 80.417, 211.71298, 78.167, 211.60799);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xFCD9B3), new Color(0xEDBD8C), shape);
        ...
        ((GeneralPath) shape).curveTo(42.5, 148.625, 44.841, 142.389, 44.67, 136.318);
        ((GeneralPath) shape).curveTo(44.499, 130.249, 34.001, 125.063, 34.875, 132.0);
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xFCD9B3), new Color(0xEDBD8C), shape);
        ...
        ((GeneralPath) shape).curveTo(65.125, 143.25, 67.643, 139.917, 67.643, 139.917);
        ((GeneralPath) shape).curveTo(67.643, 139.917, 68.25, 142.875, 68.375, 146.375);
        ...
        ((GeneralPath) shape).curveTo(67.124, 172.125, 64.375, 166.5, 63.750004, 162.375);
        ((GeneralPath) shape).curveTo(63.125008, 158.25, 62.875004, 155.625, 61.250004, 152.375);
        ((GeneralPath) shape).curveTo(59.625004, 149.125, 57.345005, 143.641, 57.345005, 143.641);
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xF2F2F2), new Color(0xC6C6C6), shape);
        ...
        ((GeneralPath) shape).curveTo(71.704, 182.864, 66.75, 184.263, 67.5, 187.693);
        ...
        ((GeneralPath) shape).curveTo(85.25, 180.625, 78.402, 181.92, 78.402, 181.92);
        ...
        ((GeneralPath) shape).curveTo(70.416, 185.334, 72.271, 184.975, 72.271, 184.975);
        ((GeneralPath) shape).lineTo(71.704, 182.864);
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0x9E6941), new Color(0x603213), shape);
        ...
        // leftShoeStripe
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(24.827, 201.564);
        ((GeneralPath) shape).curveTo(24.709, 202.78499, 26.218, 204.67299, 28.239, 205.09);
        ((GeneralPath) shape).curveTo(30.26, 205.507, 30.26, 205.507, 30.26, 205.507);
        ((GeneralPath) shape).curveTo(30.26, 205.507, 28.625, 201.062, 31.5, 198.873);
        ((GeneralPath) shape).curveTo(34.375, 196.684, 38.494, 195.977, 39.31, 193.488);
        ((GeneralPath) shape).curveTo(40.126003, 190.99901, 40.688, 180.84401, 40.688, 180.84401);
        ((GeneralPath) shape).curveTo(40.688, 180.84401, 39.312, 180.841, 38.602, 180.703);
        ((GeneralPath) shape).curveTo(37.892002, 180.564, 36.892002, 180.213, 36.892002, 180.213);
        ((GeneralPath) shape).curveTo(36.892002, 180.213, 37.125004, 189.047, 36.625004, 190.303);
        ((GeneralPath) shape).curveTo(36.125004, 191.55899, 34.0, 193.5, 31.188, 194.5);
        ((GeneralPath) shape).curveTo(28.376, 195.5, 25.153, 198.193, 24.827, 201.564);
        ((GeneralPath) shape).closePath();
        ...
        // rightShoeStripe
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(73.936, 189.525);
        ((GeneralPath) shape).curveTo(73.936, 189.525, 74.891, 189.702, 76.375, 189.625);
        ((GeneralPath) shape).curveTo(77.859, 189.548, 79.938, 189.133, 79.938, 189.133);
        ((GeneralPath) shape).curveTo(79.938, 189.133, 79.436005, 194.75, 79.938, 200.25);
        ((GeneralPath) shape).curveTo(80.438, 205.75, 81.75101, 210.125, 81.62601, 213.625);
        ((GeneralPath) shape).curveTo(81.50101, 217.125, 81.63501, 220.404, 81.63501, 220.404);
        ((GeneralPath) shape).curveTo(81.63501, 220.404, 80.31201, 220.63, 79.31601, 220.56801);
        ((GeneralPath) shape).curveTo(78.32001, 220.505, 75.503006, 219.87502, 75.503006, 219.87502);
        ((GeneralPath) shape).curveTo(75.503006, 219.87502, 75.253006, 212.62502, 75.253006, 209.93701);
        ((GeneralPath) shape).curveTo(75.253006, 207.24901, 76.128006, 204.68701, 75.94101, 200.49901);
        ((GeneralPath) shape).curveTo(75.753006, 196.311, 73.93901, 189.74901, 73.93901, 189.74901);
        s2 = new Shape2d.Path(x, y, new Color(0xCAF291), shape);
        TreeNode rightShoeStripe = new TreeNode("rightShoeStripe", s2, 3);

        // rightShoelace
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(77.486, 199.084);
        ...
        ((GeneralPath) shape).lineTo(77.486, 199.084);
        ((GeneralPath) shape).closePath();
        ...
        ((GeneralPath) shape).curveTo(39.377, 193.125, 38.0, 192.5, 38.0, 192.5);
        ...
        ((GeneralPath) shape).lineTo(31.505, 191.92299);
        ((GeneralPath) shape).curveTo(31.505, 191.92299, 31.061998, 190.812, 31.186998, 189.56198);
        ((GeneralPath) shape).curveTo(31.311998, 188.31197, 31.499998, 187.69298, 31.499998, 187.69298);
        ((GeneralPath) shape).curveTo(31.499998, 187.69298, 32.259, 188.54898, 33.786, 188.93098);
        ((GeneralPath) shape).curveTo(35.313, 189.313, 36.375, 189.188, 36.375, 189.188);
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.Path(x, y, new Color(0x374B7E), shape);
        ...
        ((GeneralPath) shape).curveTo(70.91801, 90.0, 71.25101, 88.084, 71.25101, 88.084);
        ((GeneralPath) shape).curveTo(71.25101, 88.084, 69.58501, 85.486, 69.41801, 81.826996);
        ((GeneralPath) shape).curveTo(69.25101, 78.168, 72.94001, 73.77599, 72.94001, 73.77599);
        ((GeneralPath) shape).curveTo(72.94001, 73.77599, 71.75101, 74.00299, 71.75101, 72.75199);
        ((GeneralPath) shape).curveTo(71.75101, 71.50099, 71.672005, 67.24299, 71.672005, 67.24299);
        ...
        ((GeneralPath) shape).curveTo(70.536, 91.75099, 67.91901, 90.885994, 66.438, 84.99999);
        ((GeneralPath) shape).curveTo(60.913, 83.393, 52.833, 82.833, 52.833, 82.833);
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xFAF1F6), new Color(0xDBC0AB), shape);
        ...
        ((GeneralPath) shape).curveTo(45.416, 126.99999, 40.682, 119.18599, 39.332, 117.11199);
        ((GeneralPath) shape).curveTo(37.982002, 115.03999, 36.717, 111.12799, 32.067, 110.64599);
        ((GeneralPath) shape).curveTo(27.417004, 110.16399, 27.083, 110.64599, 27.083, 110.64599);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0x2082A9), new Color(0x0E5166), shape);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xFFFFFF), new Color(0x000000), shape);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0x069287), new Color(0x003D37), shape);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0xF6B492), new Color(0xDB5A45), shape);
        ...
        ((GeneralPath) shape).curveTo(70.16901, 52.708, 69.836006, 55.971, 68.773, 55.964);
        ...
        ((GeneralPath) shape).closePath();
        s2 = new Shape2d.PathWithStroke(x, y, new Color(0x95CD62), new Color(0x4E7723), shape);
     ...
     * Creates a new transcoded SVG image.
     */
    public MaronaOutline(int width, int height) {
